...
//     console.log(await rain1155.getAssetPrice(1, USDT.address, 1))
//     console.log(await rain1155.getAssetPrice(1, BNB.address, 1))
//     console.log(await rain1155.getAssetPrice(1, CARS.address, 1))
//     console.log(await rain1155.getAssetPrice(1, PLANES.address, 1))
