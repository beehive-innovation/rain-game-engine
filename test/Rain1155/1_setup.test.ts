...
before(async () => {
    ...
    const VmStateBuilder = await ethers.getContractFactory("AllStandardOpsStateBuilder");
    vmStateBuilder = await VmStateBuilder.deploy() as AllStandardOpsStateBuilder;
    ...
    BAYC = await Erc721.deploy("Bored Ape Yatch Club", "BAYC") as ReserveTokenERC721;
    await BAYC.deployed()
