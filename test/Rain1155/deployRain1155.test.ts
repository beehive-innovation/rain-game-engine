...
describe("Rain1155 Deploy test", () => {
    ...
    before(async () => {
        const configPath = path.resolve(__dirname, "../../config/test/localhost.json");
    ...
    it("It should deploy rain1155 contract",async () => {
        ...
        const [deployer_, config_] = await getEventArgs(rain1155.deployTransaction, "Initialize", rain1155) as InitializeEvent["args"];
